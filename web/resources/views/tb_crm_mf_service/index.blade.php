...
<div class="container">
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="{{ route('services.index') }}" class="text-black text-decoration-none">SERVICES</a>
        </div>
        <div class ="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form d-inline">
                                    <a href="{{ route('services.edit', ['service' => $service->id]) }}" class="btn btn-sm btn-secondary action-btn">
