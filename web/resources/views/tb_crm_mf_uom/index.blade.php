...
<div class="container">
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="{{ route('uoms.index') }}" class="text-black text-decoration-none">UNIT OF MEASURE</a>
        </div>
        <div class ="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form d-inline">
                                    <a href="{{ route('uoms.edit', ['uom' => $uom->id]) }}" class="btn btn-sm btn-secondary action-btn">
