                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form d-inline">
                                <a href="{{ route("$route.show", [$detail_var => $detail->id]) }}" class="btn btn-secondary btn-sm mb-1 action-btn">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </div>
                            <div class="form d-inline">
                                <a href="{{ route("$route.edit", [$detail_var => $detail->id]) }}" class="btn btn-secondary btn-sm mb-1 action-btn">
                            ...
                            <form method="POST" class="form d-inline "
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" value="Delete!" class="btn btn-danger btn-sm mb-1 action-btn" onclick="return confirm('Are you sure you want to delete? This action is final')">
