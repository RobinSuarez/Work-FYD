...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('uoms.index')); ?>" >
                <?php echo csrf_field(); ?>
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="<?php echo e(route('uoms.index')); ?>">Unit of Measure</a>
        </div>
        <div class ="card-body">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $uoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('uoms.show', ['uom' => $uom->id])); ?>"><?php echo e(sprintf('%08d', $uom->id)); ?></a></td>
                            <td><?php echo e($uom->code); ?></td>
                            <td><?php echo e($uom->name); ?></td>
                            <td><input class="form-check-input" type="checkbox" value="1" <?php echo e(($uom->is_active??0) == 1 ? "checked":""); ?> disabled></td>
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('uoms.edit', ['uom' => $uom->id])); ?>" class="btn btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('uoms.destroy', ['uom' => $uom->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="form d-inline">
                <a href="<?php echo e(route('uoms.create')); ?>"
                    class="btn btn-secondary mb-3 create-btn">
                    <i class="fa-regular fa-plus"></i> New Record
                </a>
            </div>
             <?php echo $uoms->appends(\Request::except('page'))->render(); ?> 
        </div>
    </div>
</div>

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_crm_mf_uom/index.blade.php ENDPATH**/ ?>