...
<div class="container">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('statuses.index')); ?>" >
                <?php echo csrf_field(); ?>
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="<?php echo e(route('statuses.index')); ?>">Status</a>
        </div>
        <div class ="card-body">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('statuses.show', ['status' => $status->id])); ?>"><?php echo e(sprintf('%08d', $status->id)); ?></a></td>
                            <td><?php echo e($status->code); ?></td>
                            <td><?php echo e($status->name); ?></td>
                            <td><input class="form-check-input" type="checkbox" value="1" <?php echo e(($status->is_active??0) == 1 ? "checked":""); ?> disabled></td>
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('statuses.edit', ['status' => $status->id])); ?>" class="btn btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('statuses.destroy', ['status' => $status->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="form d-inline">
                <a href="<?php echo e(route('statuses.create')); ?>"
                    class="btn btn-secondary mb-3 create-btn">
                    <i class="fa-regular fa-plus"></i> New Record
                </a>
            </div>
             <?php echo $statuses->appends(\Request::except('page'))->render(); ?> 
        </div>
    </div>
</div>

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_crm_mf_status/index.blade.php ENDPATH**/ ?>