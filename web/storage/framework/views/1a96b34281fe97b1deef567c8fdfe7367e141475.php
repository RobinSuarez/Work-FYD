                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('companies.show', ['company' => $company->id])); ?>"><?php echo e(sprintf('%08d', $company->id)); ?></a></td>
                            <td><?php echo e($company->code); ?></td>
                            <td><?php echo e($company->name); ?></td>
                            <td><input class="form-check-input" type="checkbox" value="1" <?php echo e(($company->is_active??0) == 1 ? "checked":""); ?> disabled></td>
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('companies.edit', ['company' => $company->id])); ?>" class="btn btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('companies.destroy', ['company' => $company->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_crm_mf_company/index.blade.php ENDPATH**/ ?>