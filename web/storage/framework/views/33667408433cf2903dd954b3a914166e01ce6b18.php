...
<div class="container">
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="<?php echo e(route('proposals.index')); ?>">Proposals</a>
        </div>
        <div class ="card-body">
            <table class="table table-striped">
                <thead class="table-light-blue">
                    <tr>
                        ...
                        <td><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('company', 'COMPANY'));?></td>
                        <td><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('version_id', 'VERSION'));?></td>
                        <td><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('amount', 'AMOUNT'));?></td>
                        <td><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('tax_type', 'TAX TYPE'));?></td>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('proposals.show', ['proposal' => $proposal->id])); ?>"><?php echo e(sprintf('%08d', $proposal->id)); ?></a></td>
                            <td><?php echo e($proposal->date); ?></td>
                            <td><?php echo e($proposal->no); ?></td>
                            <td><?php echo e($proposal->client); ?></td>
                            <td><?php echo e($proposal->company); ?></td>
                            <td><?php echo e($proposal->version_id); ?></td>
                            <td><?php echo e(number_format($proposal->amount, 2)); ?></td>
                            <td><?php echo e($proposal->tax_type); ?></td>
                            <td><?php echo e($proposal->status); ?></td>
                            <td><?php echo e($proposal->remarks); ?></td>
                            
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('proposals.edit', ['proposal' => $proposal->id])); ?>" class="btn btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('proposals.destroy', ['proposal' => $proposal->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="form d-inline">
                <a href="<?php echo e(route('proposals.create')); ?>"
                    class="btn btn-secondary mb-3 create-btn">
                    <i class="fa-regular fa-plus"></i> New Record
                </a>
            </div>
             <?php echo $proposals->appends(\Request::except('page'))->render(); ?> 
        </div>
    </div>
</div>

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_sales_tr_proposal/index.blade.php ENDPATH**/ ?>