...
<div class="container">
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="<?php echo e(route('banks.index')); ?>" class="text-black text-decoration-none">BANKS</a>
        </div>
        <div class ="card-body">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('banks.show', ['bank' => $bank->id])); ?>"><?php echo e(sprintf('%08d', $bank->id)); ?></a></td>
                            <td><?php echo e($bank->code); ?></td>
                            <td><?php echo e($bank->name); ?></td>
                            <td><input class="form-check-input" type="checkbox" value="1" <?php echo e(($bank->is_active??0) == 1 ? "checked":""); ?> disabled></td>
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('banks.edit', ['bank' => $bank->id])); ?>" class="btn btn-sm btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('banks.destroy', ['bank' => $bank->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="form d-inline">
             ...
             <?php echo $banks->appends(\Request::except('page'))->render(); ?> 
        </div>
    </div>
</div>

<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_crm_mf_bank/index.blade.php ENDPATH**/ ?>