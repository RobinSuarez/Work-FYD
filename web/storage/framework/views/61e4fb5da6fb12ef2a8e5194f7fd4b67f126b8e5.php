...
<div class="container">
    ...
    <div class="card shadow mt-3 mb-3">
        <div class="card-header">
            <a href="<?php echo e(route('clients.index')); ?>" class="text-black text-decoration-none">CLIENTS</a>
        </div>
        <div class ="card-body">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('clients.show', ['client' => $client->id])); ?>"><?php echo e(sprintf('%08d', $client->id)); ?></a></td>
                            <td><?php echo e($client->code); ?></td>
                            <td><?php echo e($client->name); ?></td>
                            <td><input class="form-check-input" type="checkbox" value="1" <?php echo e(($client->is_active??0) == 1 ? "checked":""); ?> disabled></td>
                            <td>
                                <div class="form d-inline">
                                    <a href="<?php echo e(route('clients.edit', ['client' => $client->id])); ?>" class="btn btn-sm btn-secondary action-btn">
                                        <i class="fa-solid fa-pencil"></i>
                                    </a>
                                </div>
                                <form method="POST" class="form d-inline "
                                    action="<?php echo e(route('clients.destroy', ['client' => $client->id])); ?> " class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\FYD\web\resources\views/tb_crm_mf_client/index.blade.php ENDPATH**/ ?>